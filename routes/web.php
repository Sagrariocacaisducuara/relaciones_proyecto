...
Route::get('/servicios/{servicios}', [ServiciosController::class, 'show'])->name('servicios.shows');
Route::get('/servicios/{servicios}/editar', [ServiciosController::class, 'edit'])->name('servicios.edit');
